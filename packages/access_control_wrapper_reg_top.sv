...
module access_control_wrapper_reg_top (
	input clk_i,
	input rst_ni,
	//Implemented interface on my own. Therefor can get rid of this.
	/*
	input  tlul_pkg::tl_h2d_t tl_i,
	output tlul_pkg::tl_d2h_t tl_o,*/
	// Communication with HW
	output access_control_wrapper_reg_pkg::access_control_wrapper_reg2hw_t reg2hw, // Write
	input  access_control_wrapper_reg_pkg::access_control_wrapper_hw2reg_t hw2reg, // Read
...
//TileLink Interface is implemented in access_control_wrapper iteself
/**/
...
//*/
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[ 0] = (reg_addr == access_control_wrapper_INTR_STATE_OFFSET);
    addr_hit[ 1] = (reg_addr == access_control_wrapper_INTR_ENABLE_OFFSET);
    addr_hit[ 2] = (reg_addr == access_control_wrapper_INTR_TEST_OFFSET);
    addr_hit[ 3] = (reg_addr == access_control_wrapper_ALERT_TEST_OFFSET);
    addr_hit[ 4] = (reg_addr == access_control_wrapper_DATA_IN_OFFSET);
    addr_hit[ 5] = (reg_addr == access_control_wrapper_DIRECT_OUT_OFFSET);
    addr_hit[ 6] = (reg_addr == access_control_wrapper_MASKED_OUT_LOWER_OFFSET);
    addr_hit[ 7] = (reg_addr == access_control_wrapper_MASKED_OUT_UPPER_OFFSET);
    addr_hit[ 8] = (reg_addr == access_control_wrapper_DIRECT_OE_OFFSET);
    addr_hit[ 9] = (reg_addr == access_control_wrapper_MASKED_OE_LOWER_OFFSET);
    addr_hit[10] = (reg_addr == access_control_wrapper_MASKED_OE_UPPER_OFFSET);
    addr_hit[11] = (reg_addr == access_control_wrapper_INTR_CTRL_EN_RISING_OFFSET);
    addr_hit[12] = (reg_addr == access_control_wrapper_INTR_CTRL_EN_FALLING_OFFSET);
    addr_hit[13] = (reg_addr == access_control_wrapper_INTR_CTRL_EN_LVLHIGH_OFFSET);
    addr_hit[14] = (reg_addr == access_control_wrapper_INTR_CTRL_EN_LVLLOW_OFFSET);
    addr_hit[15] = (reg_addr == access_control_wrapper_CTRL_EN_INPUT_FILTER_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(access_control_wrapper_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(access_control_wrapper_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(access_control_wrapper_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(access_control_wrapper_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(access_control_wrapper_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(access_control_wrapper_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(access_control_wrapper_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(access_control_wrapper_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(access_control_wrapper_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(access_control_wrapper_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(access_control_wrapper_PERMIT[10] & ~reg_be))) |
               (addr_hit[11] & (|(access_control_wrapper_PERMIT[11] & ~reg_be))) |
               (addr_hit[12] & (|(access_control_wrapper_PERMIT[12] & ~reg_be))) |
               (addr_hit[13] & (|(access_control_wrapper_PERMIT[13] & ~reg_be))) |
               (addr_hit[14] & (|(access_control_wrapper_PERMIT[14] & ~reg_be))) |
               (addr_hit[15] & (|(access_control_wrapper_PERMIT[15] & ~reg_be)))));
  end
